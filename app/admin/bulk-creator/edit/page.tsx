      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div className="w-full sm:w-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-1">
            <Button variant="ghost" size="sm" onClick={() => router.push('/admin/bulk-creator')} className="h-8 w-full sm:w-auto">
      ...
      <div className="space-y-6">
        ...
        <Card className="shadow-lg border-t-4 border-t-orange-500">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <Button variant="outline" size="lg" onClick={() => router.push('/admin/bulk-creator')}><ArrowLeft className="h-4 w-4 mr-2" />Cancel</Button>
